				...
				deps.groupRepo.SetActive([]service.Group{
					{
						...
						SystemPromptConfig:   service.GroupSystemPromptConfig{Prompt: "admin-only prompt"},
						Status:               service.StatusActive,
				...
				"data": [
					{
						...
						"long_context_pricing_scope": "all",
		...
		},
		{
			...
			setup: func(t *testing.T, deps *contractDeps) {
				...
				deps.settingRepo.SetAll(map[string]string{
					...
					service.SettingKeySMTPFromName: "XY2API",
					...
					service.SettingKeySiteName:     "XY2API",
