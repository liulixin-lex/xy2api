...
import (
	...
	dbapikey "github.com/liulixin-lex/xy2api/ent/apikey"
	dbgroup "github.com/liulixin-lex/xy2api/ent/group"
	"github.com/liulixin-lex/xy2api/ent/schema/mixins"
	dbuser "github.com/liulixin-lex/xy2api/ent/user"
	dbusersub "github.com/liulixin-lex/xy2api/ent/usersubscription"
...
func (r *usageLogRepository) ListWithFilters(ctx context.Context, params pagination.PaginationParams, filters UsageLogFilters) ([]service.UsageLog, *pagination.PaginationResult, error) {
	whereClause, args := usageExportWhere(filters)
	var (
...
// usageExportWhere shares list and export filtering without pagination or association queries.
func usageExportWhere(filters UsageLogFilters) (string, []any) {
