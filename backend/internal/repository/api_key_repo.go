...
import (
	...
	"github.com/liulixin-lex/xy2api/ent/apikey"
	...
	m, err := r.activeQuery().
		...
		WithGroup(func(q *dbent.GroupQuery) {
			q.Select(
				...
				group.FieldShowExclusiveBadge,
				group.FieldSystemPromptConfig,
				group.FieldStatus,
				...
				group.FieldLongContextPricingScope,
				group.FieldLongContextPricingModels,
...
func groupEntityToService(g *dbent.Group) *service.Group {
	...
	return &service.Group{
		...
		SystemPromptConfig:              g.SystemPromptConfig.Clone(),
		Status:                          g.Status,
		Hydrated:                        true,
		...
		LongContextPricingModels:        append([]string(nil), g.LongContextPricingModels...),
