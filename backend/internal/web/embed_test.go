...
func TestInjectSiteTitle(t *testing.T) {
	t.Run("replaces_title_with_site_name", func(t *testing.T) {
		html := []byte(`<html><head><title>XY2API - AI API Gateway</title></head><body></body></html>`)
		...
		assert.NotContains(t, string(result), "XY2API")
	})
	...
	t.Run("returns_unchanged_when_title_has_attributes", func(t *testing.T) {
		...
		html := []byte(`<html><head><title lang="en">XY2API</title></head><body></body></html>`)
	...
	t.Run("escapes_ampersand_in_site_name", func(t *testing.T) {
		html := []byte(`<html><head><title>XY2API</title></head><body></body></html>`)
	...
	t.Run("preserves_rest_of_html", func(t *testing.T) {
		html := []byte(`<html><head><meta charset="UTF-8"><title>XY2API</title><script src="app.js"></script></head><body><div id="app"></div></body></html>`)
