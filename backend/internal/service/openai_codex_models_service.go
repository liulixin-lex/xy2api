...
const (
	...
	configuredCodexCustomDescription   = "Custom model routed through XY2API."
...
func newConfiguredCodexModelDescriptor(modelID string) configuredCodexModelDescriptor {
	...
	if isDeepSeekCodexModel(modelID) {
		...
		descriptor.Description = "DeepSeek coding and reasoning model routed through XY2API."
	...
	if isGrokCodexModel(modelID) {
		...
		descriptor.Description = "Grok coding and reasoning model routed through XY2API."
		descriptor.SupportsParallelToolCalls = true
	...
	if isClaudeCodexModel(modelID) {
		...
		descriptor.Description = "Claude coding and reasoning model routed through XY2API."
		descriptor.SupportsParallelToolCalls = true
	...
	if isOpenAICodexGPTModel(modelID) {
		...
		descriptor.Description = "OpenAI GPT coding model routed through XY2API."
		descriptor.SupportsParallelToolCalls = true
