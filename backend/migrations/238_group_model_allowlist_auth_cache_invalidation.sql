-- model_allowlist controls request admission and is serialized into API-key auth
-- snapshots. Keep out-of-band group updates from leaving stale authorization data.
