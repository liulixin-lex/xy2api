export default {
    accounts: {
      stateTicket: {
 acquireAll: '重新获取已启用模型',
 iqDegradedRecovery: '有效答错后恢复',

  "models": "独立管理的模型",
  "missingPolicy": "缺票时的处理",
  "block": "暂停目标模型，等待有效票据",
  "allowUnprotected": "允许无票转发（不受 STATE 保护）",
  "ticketAvailability": "票据可用性",
  "modelVerification": "返回模型核验",
  "iqResult": "智商检测结果",
  "verified": "已完成核验",
  "pending": "待核验",
  "protection": "保护状态",
  "iqRetestQueued": "已安排恢复后智商复检，保留上次有效判定",
  "protections": {
    "protected": "STATE 保护中",
    "unprotected": "无票转发",
    "paused": "等待 STATE",
...
,
  ...
  "planPro": "Pro（292）",
  "planTeam": "Team（332）",
  "planHint": "手动选择套餐。票据需符合所选长度，并通过实际返回模型和固定代理验证。更改套餐后需重新获取。",
  ...
  "globalPoolHint": "这里只控制本账号是否使用票据。采集统一使用全局 IP 池，日常请求仍走本账号的固定代理。",
  "proxy": "采集代理",
