export default {
  ...
  allIQStatuses: '全部智商',
      iqInterval: '检测频率（分钟）',
      iqHint: '默认每15分钟检测一次。最终答案为21视为聪明；未知状态交回原有调度。每个账号仅保留最近两轮记录。',
      iqBulkEdit: '修改智商检测设置',
      iqRun: '立即检测',
      iqRecords: '检测记录',
      iqBlocked: '智商检测停用',
      ...
      iqEffort: "思考深度",
      iqPullModels: "拉取模型",
      iqSaveCredentials: "凭据或连接设置已修改，请先保存后再拉取。",
      ...
      iqEffortUnsupported: "该模型的上游能力不支持此深度，请选择支持值或 upstream_default。",
      iqModelsFailed: "拉取失败，可继续输入自定义模型；如有旧目录，仅供参考。",
      iqModelsStale: "目录已过期，请重新拉取。",
      iqModelsCached: "来自该账号上游的缓存目录（5分钟）。",
      iqModelsUpstream: "来自该账号上游；返回列表不保证每个模型均可调用。",
      iqModelsEmpty: "上游未返回文本模型，可输入自定义模型。",
      iqOutputSettings: "输出格式设置",
      iqOutputMode: "输出约束",
      iqCompat: "兼容模式：提示输出简洁 JSON",
      iqStrict: "严格模式：请求 JSON Schema",
      ...
      iqNormalizedAnswer: "提取答案",
      iqRawAnswer: "查看原始回答",
      iqRunning: "检测中",
      iqLegacyResult: "旧版记录，未保存提取信息",
      iqFormatMismatch: "输出未遵循格式要求；本次按明确答案判分。",
