export default {
  ...
  allIQStatuses: '全部智商',
      ...
      iqExecutionStates: {"idle": "等待下轮", "pending": "排队中", "running": "检测中", "deferred": "已延期", "paused": "已暂停"},
      ...
      iqDiagnosticLabels: { error_code: "上游错误码", error_type: "错误类型", retry_after: "上游允许重试时间", retry_after_unbounded: "重试等待超出范围，已暂停", input_tokens: "输入 Token", output_tokens: "输出 Token", reasoning_tokens: "推理 Token", retry_visibility: "传输重试可见性",  parser_version: '解析器版本', stage: '阶段', code: '原因代码', http_status: 'HTTP 状态', media_type: '内容类型', content_encoding: '压缩格式', protocol: '协议', transport: '传输方式', format_detected: '已兼容识别格式', event_type: '事件类型', event_index: '事件序号', field: '字段位置', offset: '字节位置', bytes_read: '读取字节数', request_id: '上游请求编号' },
      iqReason: '判定原因',
