...
,
        ...
        "diagnostics": "详情",
        "issuedAt": "内嵌时间",
        "firstObservedAt": "首次获取",
        "effectiveExpiry": "到期时间",
        "lastReplay": "最近固定代理复验",
        "probeStage": "采集阶段",
        "harvestStage": "动态代理采集",
        "replayStage": "固定代理复验",
        "observedLength": "票据长度",
        "failureReason": "失败原因",
        "observationCoverage": "业务核验统计",
        "coverageCounts": "已核验 {checked} 次 · 未确认 {unconfirmed} 次",
        "diagnosticHint": "统计约每 30 秒更新。",
        "updatedAt": "更新于 {time}",
        "businessResults": {
          "verified": "模型一致",
          "model_mismatch": "模型不符",
          "state_312": "312 异常信号",
          "oversized": "未确认：响应超过观察上限",
          "unsupported_encoding": "未确认：不支持的响应编码",
          "upstream_failed": "未确认：上游请求失败",
          "unconfirmed": "未确认：响应不完整或无法解析",
          "not_observed": "暂无记录"
        },
        "failureReasons": {
          "invalid_ticket_time": "票据已过期或时间无效",
          "rate_limited": "上游限流或配额不足",
          "auth_rejected": "上游拒绝认证或权限",
          "model_capacity": "模型繁忙",
          "response_failed": "上游请求失败",
          "invalid_state_header": "STATE 响应头重复或格式无效",
        ...
        "missingPolicy": "缺票策略",
        "block": "暂停转发，等待票据",
        "allowUnprotected": "无票转发（不受保护）",
        "ticketAvailability": "票据",
        "modelVerification": "返回模型核验",
        "iqResult": "智商检测",
        "verified": "通过",
        "pending": "待核验",
        "protection": "保护状态",
        ...
        "title": "STATE 票据",
        "description": "按模型自动获取、续期和守护。",
        "enable": "启用此账号的 STATE 票据",
        "plan": "套餐",
        "planPro": "Pro（292）",
        "planTeam": "Team（332）",
        "planHint": "更换套餐后需重新获取票据。",
        "globalOff": "全局开关已关闭，账号设置仍可保存。",
        "gatewaySettings": "网关设置",
        "globalPoolConfigured": "动态池：{address}",
        "globalPoolMissing": "未配置动态池，请前往网关设置。",
        "globalPoolHint": "采集走动态池，业务走固定代理。",
        "proxy": "采集代理",
      ...
      schedulable: '参与调度',
  iqCheck: '智商检测',
      iqFixedHint: "按固定间隔检测，连续失败时会延长等待。",
      iqDefaultEffortHint: "使用上游默认值。",
      iqCompatDescription: "用提示词要求 JSON；返回明确答案时也可判定，兼容更多上游。",
      iqStrictDescription: "额外使用 JSON Schema 约束输出，需要上游支持；格式有偏差但答案明确时仍可判定。",
      iqNeedsAttention: "待处理",
      iqWaiting: "等待检测",
      iqNextCheck: "下次检测",
      iqPreviousValid: "上次有效结果",
      iqNotChecked: "尚未检测",
      iqForbiddenRetry: "上游暂时拒绝请求（HTTP 403），将自动重试。",
      iqRequest: "请求",
      iqParsing: "解析",
      iqVersions: "版本",
      iqTechnicalDetails: "技术详情",
      iqRequestTiming: "请求耗时",
      iqTokenUsage: "Token 用量",
      iqFirstByteValue: "首字节 {value}",
      iqRequestTimeValue: "请求 {value}",
      iqInputTokensValue: "输入 {value}",
      iqOutputTokensValue: "输出 {value}",
      iqReasoningIncluded: "（含推理 {value}）",
      iqReasoningTokensValue: "推理 {value}",
      iqPlugin: "插件",
      iqYes: "是",
      iqNo: "否",
      iqCopyField: "复制{field}",
      iqCopied: "已复制",
      iqCopyFailed: "复制失败，请选择文本复制。",
      iqStages: {"request": "准备请求", "http": "接收响应", "read": "读取响应", "decode": "解码响应", "parse": "解析响应", "terminal": "检查完成状态", "format": "识别格式", "grade": "答案判定"},
      iqAnswerSources: {"terminal_output": "完成响应", "completed_items": "完成消息补全"},
      iqRetryVisibility: {"single_attempt": "本次尝试发送 1 次请求", "single_application_call": "本次调用发送 1 次应用请求", "plugin_attempts_unknown": "插件内部重试次数未知", "unknown": "内部重试次数未知"},
      iqEfforts: { upstream_default: "default", none: "none", minimal: "minimal", low: "low", medium: "medium", high: "high", xhigh: "xhigh", max: "max" },
      iqHistoryFailed: "检测记录加载失败，请重试。",
      iqDownloadFailed: "诊断下载失败，请重试。",
      iqLastValid: '最近有效判定',
      iqRetainedAssessment: '本轮未取得有效答案，继续保留上次有效判定。',
      iqCapacityHint: '正在等待账号名额；持续等待时可降低检测频率或检查业务并发占用。',
      iqAttempts: '调用明细（{count} 次）',
      iqAttemptNumber: '第 {number} 次',
      iqNoAnswer: "未取得回答",
      iqProtocol: "请求协议",
      iqDuration: "本轮耗时",
      iqHistoryRetention: "最近三轮检测",
      iqEffortInvalid: "请输入有效的思考深度。",
      iqModelInvalid: "模型名称不能为空，且不得包含空格或超过256个字符。",
      iqModelsReady: "已同步 {count} 个模型",
      iqModelSearch: "搜索或输入模型名称",
      iqUseCustom: "使用自定义值",
      iqAdvanced: "高级设置",
  allIQStatuses: '全部智商',
      iqInterval: '检测频率（分钟）',
      iqHint: "答案为21时标记聪明，每个账号保留最近三轮记录。",
      iqBulkEdit: '修改智商检测设置',
      iqRun: '立即检测',
      iqRecords: '检测记录',
      iqOff: '未开启',
      iqOpenRecords: '{status}，查看检测记录',
      iqCurrentState: '当前检测状态',
      iqStatusFailed: '状态刷新失败，请重试。',
      iqRefreshState: '刷新检测状态',
      iqBusyDeferrals: '已连续等待 {count} 次',
      iqBlocked: '智商检测停用',
      iqQueued: '已排队，检测完成后自动更新',
      iqFailed: '智商检测操作失败',
      iqEmpty: '暂无检测记录',
      iqAnswer: '最终回答',
      iqModel: "检测模型",
      iqEffort: "思考深度",
      iqPullModels: "拉取模型",
      iqSaveCredentials: "请先保存连接设置，再同步模型。",
      iqModelHint: "可输入完整模型 ID；拉取不会更改账号的模型白名单。",
      iqEffortHint: "可输入深度值；upstream_default 不发送深度参数，none 则显式发送。",
      iqUpstreamDefault: "上游默认（不发送参数）",
      iqCapabilitiesUpstream: "能力来源：上游。",
      iqCapabilitiesReference: "能力来源：参考信息，未经该账号验证。",
      iqCapabilitiesUnknown: "能力未知，可保存自定义值。",
      iqEffortUnsupported: "当前模型不支持此深度，请重新选择。",
      iqModelsFailed: "同步失败，请重试。当前模型已保留。",
      ...
      iqCompat: "兼容模式",
      iqStrict: "严格格式",
      iqStrictHint: "不支持格式或参数时记为未知，不自动重试或更换模型。格式不合规但答案明确时仍正常判分。",
      iqBulkFieldsHint: "只修改下方勾选的字段，其余设置保持每个账号的原值。批量设置请直接输入模型 ID。",
      iqSelectFields: "请勾选要修改的检测字段并修正无效值。",
      iqNormalizedAnswer: "答案",
      iqRawAnswer: "查看原始回答",
      iqRunning: "检测中",
      iqLegacyResult: "旧版记录，部分信息未保存",
      iqFormatMismatch: "回答格式有差异，已按明确答案判定。",
      iqReportedModel: "返回模型",
      iqGrader: "判题版本",
      iqTimeout: "检测超时（秒）",
      iqExecution: "执行",
      iqNextEligible: "下次可执行",
      iqLastAssessment: "最近检测",
      iqDownload: "下载诊断",
      iqQueuedAt: "已排队，最早执行时间：{time}",
      iqExecutionStates: {
        retry_wait: '等待一次补试',
        protocol_cooldown: '连续协议失败，冷却后自动恢复检测',
"idle": "等待下轮", "pending": "排队中", "running": "检测中", "deferred": "已延期", "paused": "已暂停"},
      iqFreshness: {"fresh": "近期结果", "stale": "结果已过期", "never_checked": "尚未检测"},
      iqExecutionReasons: {
        retry_wait: '等待一次补试',
        protocol_cooldown: '连续协议失败，冷却后自动恢复检测',
"group_paused": "配额组已暂停，请处理额度后手动排队","minimum_interval": "最小间隔未到", "upstream_cooldown": "上游冷却", "daily_budget": "今日预算已用完", "group_daily_budget": "配额组今日预算已用完", "group_cooldown": "配额组冷却", "quota_group_unconfigured": "配额组未配置", "account_disabled": "账号人工停用", "account_expired": "账号过期", "account_cooldown": "账号健康冷却", "account_quota": "账号额度不足", "account_unavailable": "账号暂不可读", "concurrency_unavailable": "并发服务暂不可用", "waiting_state": "\u7b49\u5f85 STATE", "state_recovered": "STATE \u5df2\u6062\u590d\uff0c\u7b49\u5f85\u590d\u68c0", "account_busy": "账号繁忙", "start_unavailable": "任务暂未启动", "quota_exhausted": "额度不足，请处理后重新排队", "authentication_unavailable": "认证失败，请检查凭据", "permission_denied": "权限不足，请检查授权", "policy_denied": "上游拒绝，请联系服务方", "unsupported_model": "模型不支持，请修改配置", "unsupported_parameter": "参数不支持，请修改配置"},
      iqReasons: {
        no_valid_history: '没有同配置版本的有效历史结果',
        zero_byte_response: '未收到响应正文',
        missing_final_message: '响应已完成，但缺少最终消息',
        empty_final_text: '最终消息没有回答文本',
        retry_deadline_exceeded: '本轮恢复等待已超时',
        invalid_output_identity: '输出消息标识无效',
        invalid_completed_message: '完成消息的身份或状态无效',
        conflicting_output_identity: '输出消息标识冲突',

        unsupported_parameter: "参数不支持，请修改配置",
        policy_denied: "上游拒绝，请联系服务方",
        permission_denied: "权限不足，请检查授权",
        quota_exhausted: "额度不足，请处理后重新排队",
        start_unavailable: "任务暂未启动",
        account_busy: "账号繁忙",
        concurrency_unavailable: "并发服务暂不可用",
        account_quota: "账号额度不足",
        account_cooldown: "账号健康冷却",
        account_expired: "账号过期",
        account_disabled: "账号人工停用",
        quota_group_unconfigured: "配额组未配置",
        group_cooldown: "配额组冷却",
        group_daily_budget: "配额组今日预算已用完",
        daily_budget: "今日预算已用完",
        upstream_cooldown: "上游冷却",
        minimum_interval: "最小间隔未到",
        response_format_mismatch: '响应头与正文格式不匹配',
        unsupported_media_type: '上游返回了不支持的响应格式',
        invalid_event_json: '响应事件的 JSON 无法解析',
        duplicate_critical_field: '响应关键字段重复，无法可靠判定',
        duplicate_event_field: '响应事件包含重复字段',
        invalid_event_shape: '响应事件字段类型不符合预期',
        invalid_terminal_response: '缺少完整的最终响应对象',
        event_type_mismatch: '响应事件名称与内容不一致',
        data_after_done: '响应结束后仍收到额外数据',
        event_too_large: '单个响应事件超出大小限制',
        too_many_events: '响应事件数量超出限制',
        response_decompression_failed: '上游响应解压失败',
        unsupported_content_encoding: '不支持上游响应的压缩格式',
        conflicting_final_response: '最终响应互相冲突',
        empty_response: "回答为空",
        invalid_answer_structure: "回答结构无效或含重复字段",
        unparseable_answer: "未找到明确的最终答案",
        response_read_failed: "响应读取中断",
        upstream_error: "上游响应包含错误",
        request_failed: "上游请求失败",
        transport_unavailable: "请求传输服务不可用",
        account_unavailable: "账号不可用",
        authentication_unavailable: "账号鉴权不可用",
        unsupported_account_type: "不支持的账号类型",
        invalid_endpoint: "上游地址无效",
        http_400: "上游不接受模型、参数或请求",
        http_403: "上游暂时拒绝请求（HTTP 403）",
        http_404: "上游模型或接口不存在",
        http_500: "上游内部错误",
        http_502: "上游网关错误",
        http_503: "上游暂不可用",
        correct_answer: "答案为21",
        wrong_answer: "明确答案不是21",
        ambiguous_answer: "答案含糊或存在冲突",
        answer_not_found: "未找到明确答案",
        invalid_answer: "答案格式无法解析",
        invalid_json: "JSON 不合法或含重复字段",
        conflicting_answers: "存在冲突答案",
        refusal: "上游拒答",
        timeout: "请求超时",
        interrupted: "检测中断，已恢复调度",
        configuration_changed: "检测配置已更新，等待重新检测",
        cancelled_by_account_change: "账号或配置变化，丢弃旧任务",
        http_401: "鉴权失败",
        http_429: "上游限额或限流",
        unsupported_model: "模型或账号不支持",
        empty_answer: "回答为空",
        incomplete_response: "响应未完成",
        invalid_response: "响应协议不合法",
        response_too_large: "响应超出大小限制",
        stream_interrupted: "响应流中断",
        transport_error: "连接上游失败",
      },
      iqDiagnostic: "检测详情",
      iqDiagnosticHint: '本轮未得到可判分答案，未知状态由原调度规则处理。',
      iqDiagnosticLabels: {
        ignored_types: '忽略的项目类型',
        done_messages: '完成消息数',
        terminal_items: '终态输出数',
        ignored_items: '忽略项目数',
        answer_source: '答案来源',
        first_byte_ms: '首字节耗时',
        total_ms: '请求耗时',
 error_code: "上游错误码", error_type: "错误类型", retry_after: "上游允许重试时间", retry_after_unbounded: "重试等待超出范围，已暂停", input_tokens: "输入 Token", output_tokens: "输出 Token", reasoning_tokens: "推理 Token", retry_visibility: "请求尝试",  parser_version: '解析器版本', stage: '阶段', code: '原因代码', http_status: 'HTTP 状态', media_type: '响应格式', content_encoding: '压缩格式', protocol: '协议', transport: '传输方式', format_detected: '已兼容识别格式', event_type: '事件类型', event_index: '事件序号', field: '字段位置', offset: '字节位置', bytes_read: '读取字节数', request_id: '请求 ID' },
      ...
      usageWindowsHint: '“5h / 7d”是上游账号（如 OpenAI ChatGPT、Claude）官方的滚动用量窗口限制，由上游对账号设定，并非 xy2api 配置，也与你映射的模型无关。窗口滚动到期后用量会自动重置，无法在 xy2api 端解除该限制。',
      ollamaCloud: {
      ...
      upstreamBilling: {
        trustWarning: '此倍率由上游站点针对当前 API Key 自行声明。XY2API 无法验证该值是否与实际扣费一致；上游站点或中间代理可能返回伪造、过期或被篡改的数据。请结合账单、余额变化和实际用量自行核验。',
      ...
      usageWindow: {
        ...
        grokRequests: '请求',
        grokTokens: 'Token',
        grokFreeQuota24hHint: '按 xy2api 近 24 小时本地 Token 用量估算（上限 {limit}）',
      ...
      grok: {
        ...
        ttsTextLabel: 'TTS 文本',
        ttsTextPlaceholder: '例如：Hello from XY2API connectivity test.',
      ...
      poolModeInfo:
        '启用后，上游 429/403/401 错误将自动重试而不标记账号限流或错误，适用于上游指向另一个 xy2api 实例的场景。',
