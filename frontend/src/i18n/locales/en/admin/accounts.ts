export default {
  ...
  allIQStatuses: 'All IQ statuses',
      ...
      iqHint: 'Checks every 15 minutes by default. A final answer of 21 passes; unknown results return control to normal scheduling. Only the last two attempts are retained per account.',
      ...
      iqSaveCredentials: "Save credential or connection changes before fetching models.",
      ...
      iqEffortUnsupported: "Upstream capabilities do not support this effort. Choose a supported value or upstream_default.",
      iqModelsFailed: "Fetch failed. Custom model input remains available; any old catalog is for reference.",
      iqModelsStale: "Catalog is stale. Fetch again.",
      ...
      iqModelsEmpty: "No text models returned. Enter a custom model.",
      iqOutputSettings: "Output format settings",
      iqOutputMode: "Output constraint",
      iqCompat: "Compatible: request concise JSON",
      iqStrict: "Strict: request JSON Schema",
      ...
      iqNormalizedAnswer: "Extracted answer",
      iqRawAnswer: "View original answer",
      iqRunning: "Running",
      iqLegacyResult: "Legacy record; extraction metadata unavailable",
      iqFormatMismatch: "Output did not follow the requested format; the explicit answer was graded.",
      iqReportedModel: "Model reported by upstream",
      iqGrader: "Grader version",
      iqSchedule: "Probe schedule",
      iqFixed: "Fixed interval",
      iqAdaptive: "Adaptive interval",
      iqMaxInterval: "Maximum interval (minutes)",
      iqDailyLimit: "Daily request limit (UTC)",
      iqTimeout: "Total timeout (seconds)",
      ...
      iqDownload: "Download last two diagnostics",
