export default {
  ...
  iqCheck: 'IQ check',
      iqEfforts: {"upstream_default":"Upstream default","none":"None","minimal":"Minimal","low":"Low","medium":"Medium","high":"High","xhigh":"Extra high","max":"Maximum"},
      ...
      iqBudgetWarning: 'The daily budget does not cover every scheduled round plus one recovery attempt. Checks wait until the next day when it is exhausted.',
      ...
      iqGroupPlaceholder: "Leave empty for an independent quota",
  ...
  allIQStatuses: 'All IQ statuses',
      ...
      iqBudgetRemaining: 'Checks remaining today',
      ...
      iqReportedModel: "Model reported by upstream",
      iqGrader: "Grader version",
      iqSchedule: "Check mode",
      iqFixed: "Fixed interval",
      iqAdaptive: "Adaptive interval",
      iqMaxInterval: "Maximum interval (minutes)",
      iqDailyLimit: "Daily check limit (UTC)",
      iqTimeout: "Check timeout (seconds)",
      iqQuotaGroup: "Shared quota group (optional)",
      iqQuotaGroupHint: "Use an explicitly configured shared quota group. Unconfigured groups defer probes.",
      iqScheduleHint: "Base interval: up to {count} rounds/day. Scheduled wait can reach {interval} minutes, plus queue and request time. Smart/degraded describes this question only.",
...
"group_paused": "Quota group paused; resolve quota and requeue","minimum_interval": "Minimum interval", "upstream_cooldown": "Upstream cooldown", "daily_budget": "Daily budget exhausted", "group_daily_budget": "Group daily budget exhausted", "group_cooldown": "Group cooldown", "quota_group_unconfigured": "Quota group not configured", "account_disabled": "Account disabled", "account_expired": "Account expired", "account_cooldown": "Account cooldown", "account_quota": "Account quota exhausted", "account_unavailable": "Account unavailable", "concurrency_unavailable": "Concurrency unavailable", "account_busy": "Account busy", "start_unavailable": "Start unavailable", "quota_exhausted": "Quota exhausted; resolve before requeuing", "authentication_unavailable": "Authentication failed; check credentials", "permission_denied": "Permission denied; check authorization", "policy_denied": "Upstream denied; contact provider", "unsupported_model": "Unsupported model; update configuration", "unsupported_parameter": "Unsupported parameter; update configuration"},
      iqReasons: {
        ...
        http_403: "Upstream access denied",
      ...
      iqDiagnostic: 'Check diagnostics',
 ...
 error_code: "Upstream error code", error_type: "Error type", retry_after: "Upstream retry time", retry_after_unbounded: "Retry delay unbounded; paused", input_tokens: "Input tokens", output_tokens: "Output tokens", reasoning_tokens: "Reasoning tokens", retry_visibility: "Transport retry visibility",  parser_version: 'Parser version', stage: 'Stage', code: 'Reason code', http_status: 'HTTP status', media_type: 'Media type', content_encoding: 'Compression', protocol: 'Protocol', transport: 'Transport', format_detected: 'Format detected', event_type: 'Event type', event_index: 'Event index', field: 'Field path', offset: 'Byte offset', bytes_read: 'Bytes read', request_id: 'Upstream request ID' },
      iqReason: 'Reason',
