export default {
  ...
  allIQStatuses: 'All IQ statuses',
      ...
      iqExecutionStates: {"idle": "Waiting", "pending": "Pending", "running": "Running", "deferred": "Deferred", "paused": "Paused"},
      ...
      iqDiagnosticLabels: { error_code: "Upstream error code", error_type: "Error type", retry_after: "Upstream retry time", retry_after_unbounded: "Retry delay unbounded; paused", input_tokens: "Input tokens", output_tokens: "Output tokens", reasoning_tokens: "Reasoning tokens", retry_visibility: "Transport retry visibility",  parser_version: 'Parser version', stage: 'Stage', code: 'Reason code', http_status: 'HTTP status', media_type: 'Media type', content_encoding: 'Compression', protocol: 'Protocol', transport: 'Transport', format_detected: 'Format detected', event_type: 'Event type', event_index: 'Event index', field: 'Field path', offset: 'Byte offset', bytes_read: 'Bytes read', request_id: 'Upstream request ID' },
      iqReason: 'Reason',
