export default {
    accounts: {
      stateTicket: {
 acquireAll: 'Reacquire enabled models',
 iqDegradedRecovery: 'Recovery after a valid wrong answer',

  "models": "Independently managed models",
  "missingPolicy": "When no ticket is available",
  "block": "Pause the target model until a ticket is ready",
  "allowUnprotected": "Allow forwarding without STATE protection",
  "ticketAvailability": "Ticket availability",
  "modelVerification": "Returned model verification",
  "iqResult": "IQ check result",
  "verified": "Verified",
  "pending": "Pending",
  "protection": "Protection",
  "iqRetestQueued": "Recovery IQ check queued; last valid assessment retained",
  "protections": {
 ...
 "not_configured": "No IQ check for this model",
    "smart": "Smart",
    "degraded": "Degraded",
...
,
  ...
  "planPro": "Pro (292)",
  "planTeam": "Team (332)",
  "planHint": "Select the plan manually. Tickets must match the selected length and pass actual model and fixed proxy verification. Changing plans requires a new ticket.",
  ...
  "globalPoolHint": "This switch controls tickets for this account. Harvesting uses the global pool; normal requests keep this account's fixed proxy.",
  "proxy": "Harvest proxy",
  ...
  "saveFailed": "Save failed. Check the proxy URL format and retry.",
