export default {
    accounts: {
      stateTicket: {
        ...
        "diagnostics": "Details",
        "issuedAt": "Embedded time",
        "firstObservedAt": "First observed",
        "effectiveExpiry": "Expires",
        "lastReplay": "Latest fixed-proxy replay",
        "probeStage": "Acquisition stage",
        "harvestStage": "Dynamic-proxy acquisition",
        "replayStage": "Fixed-proxy replay",
        "observedLength": "Ticket length",
        "failureReason": "Failure reason",
        "observationCoverage": "Business observations",
        "coverageCounts": "{checked} checked · {unconfirmed} unconfirmed",
        "diagnosticHint": "Statistics refresh about every 30 seconds.",
        "updatedAt": "Updated {time}",
        "businessResults": {
          "verified": "Model matches",
          "model_mismatch": "Model mismatch",
          "state_312": "312 anomaly signal",
          "oversized": "Unconfirmed: observation size limit exceeded",
          "unsupported_encoding": "Unconfirmed: unsupported response encoding",
          "upstream_failed": "Unconfirmed: upstream request failed",
          "unconfirmed": "Unconfirmed: incomplete or invalid response",
          "not_observed": "No record"
        },
        "failureReasons": {
          "invalid_ticket_time": "Ticket expired or has an invalid timestamp",
          "rate_limited": "Upstream rate or quota limit",
          "auth_rejected": "Upstream authentication or permission rejected",
          "model_capacity": "Model busy",
          "response_failed": "Upstream request failed",
          "invalid_state_header": "Duplicate or invalid STATE response header",
        ...
        "block": "Pause until a ticket is ready",
        "allowUnprotected": "Forward without protection",
        "ticketAvailability": "Ticket",
        "modelVerification": "Returned model verification",
        "iqResult": "IQ check",
        "verified": "Verified",
        "pending": "Pending",
        "protection": "Protection",
        "iqRetestQueued": "Recheck queued",
        "protections": {
          "protected": "Protected by STATE",
          "unprotected": "Forwarding without STATE",
          "paused": "Waiting for STATE",
          "disabled": "Disabled"
        },
        "iq": {
          "not_enabled": "IQ check disabled",
        ...
        "title": "STATE ticket",
        "description": "Automatic acquisition, renewal and monitoring per model.",
        "enable": "Enable STATE tickets for this account",
        "plan": "Account plan",
        "planPro": "Pro (292)",
        "planTeam": "Team (332)",
        "planHint": "Changing plans requires new tickets.",
        "globalOff": "Global switch off. Account settings can still be saved.",
        "gatewaySettings": "Gateway settings",
        "globalPoolConfigured": "Dynamic pool: {address}",
        "globalPoolMissing": "No dynamic pool. Configure it in gateway settings.",
        "globalPoolHint": "Acquisition uses the dynamic pool; requests use the fixed proxy.",
        "proxy": "Harvest proxy",
        ...
        "harvestFailed": "Acquisition did not start. Please retry later.",
        "retry": "Retry",
        "states": {
          "disabled": "Disabled",
  ...
  iqCheck: 'IQ check',
      iqFixedHint: "Checks run at a fixed interval; repeated failures extend the wait.",
      iqDefaultEffortHint: "Use the upstream default.",
      iqCompatDescription: "Request JSON through the prompt. Clear answers in other formats can also be graded, for broader compatibility.",
      iqStrictDescription: "Also constrain output with JSON Schema, which requires upstream support. Clear answers can still be graded if the format differs.",
      iqNeedsAttention: "Action needed",
      iqWaiting: "Waiting for a check",
      iqNextCheck: "Next check",
      iqPreviousValid: "Last valid result",
      iqNotChecked: "Not checked yet",
      iqForbiddenRetry: "Upstream temporarily rejected the request (HTTP 403). Checks will resume automatically.",
      iqRequest: "Request",
      iqParsing: "Parsing",
      iqVersions: "Versions",
      iqTechnicalDetails: "Technical details",
      iqRequestTiming: "Request timing",
      iqTokenUsage: "Token usage",
      iqFirstByteValue: "First byte {value}",
      iqRequestTimeValue: "Request {value}",
      iqInputTokensValue: "Input {value}",
      iqOutputTokensValue: "Output {value}",
      iqReasoningIncluded: " (including {value} reasoning)",
      iqReasoningTokensValue: "Reasoning {value}",
      iqPlugin: "Plugin",
      iqYes: "Yes",
      iqNo: "No",
      iqCopyField: "Copy {field}",
      iqCopied: "Copied",
      iqCopyFailed: "Copy failed. Select the text to copy it.",
      iqStages: {"request": "Request preparation", "http": "HTTP response", "read": "Response reading", "decode": "Response decoding", "parse": "Response parsing", "terminal": "Completion check", "format": "Format detection", "grade": "Answer grading"},
      iqAnswerSources: {"terminal_output": "Completed response", "completed_items": "Completed-message recovery"},
      iqRetryVisibility: {"single_attempt": "1 request sent in this attempt", "single_application_call": "1 application request in this call", "plugin_attempts_unknown": "Plugin retry count unknown", "unknown": "Internal retry count unknown"},
      iqEfforts: { upstream_default: "default", none: "none", minimal: "minimal", low: "low", medium: "medium", high: "high", xhigh: "xhigh", max: "max" },
      iqHistoryFailed: "Could not load check history. Try again.",
      iqDownloadFailed: "Could not download diagnostics. Try again.",
      iqLastValid: 'Last valid assessment',
      iqRetainedAssessment: 'This round produced no valid answer. The last valid assessment still applies.',
      iqCapacityHint: 'Waiting for an account slot. If this persists, reduce the check frequency or inspect business concurrency.',
      iqAttempts: 'Attempts ({count})',
      iqAttemptNumber: 'Attempt {number}',
      iqNoAnswer: "No answer received",
      iqProtocol: "Request protocol",
      iqDuration: "Round duration",
      iqHistoryRetention: "Last three checks",
      iqEffortInvalid: "Enter a valid reasoning effort.",
      iqModelInvalid: "Enter a model name without spaces, up to 256 characters.",
      iqModelsReady: "Synced {count} models",
      iqModelSearch: "Search or enter a model name",
      iqUseCustom: "Use custom value",
      iqAdvanced: "Advanced settings",
  allIQStatuses: 'All IQ statuses',
      iqInterval: 'Check interval (minutes)',
      iqHint: "An answer of 21 passes. The last three attempts are retained per account.",
      iqBulkEdit: 'Change IQ check settings',
      iqRun: 'Run IQ check',
      iqRecords: 'IQ check history',
      iqOff: 'Off',
      iqOpenRecords: '{status}, view check history',
      iqCurrentState: 'Current check status',
      iqStatusFailed: 'Could not refresh status. Please retry.',
      iqRefreshState: 'Refresh check status',
      iqBusyDeferrals: 'Waiting for capacity: {count} consecutive deferrals',
      iqBlocked: 'Paused by IQ check',
      iqQueued: 'Queued. Results update automatically when complete.',
      iqFailed: 'IQ check operation failed',
      iqEmpty: 'No checks yet',
      iqAnswer: 'Final answer',
      iqModel: "Check model",
      iqEffort: "Reasoning effort",
      iqPullModels: "Fetch models",
      iqSaveCredentials: "Save connection changes before syncing models.",
      iqModelHint: "Enter an exact model ID. Fetching does not change the account allowlist.",
      iqEffortHint: "Enter an effort value. upstream_default omits the parameter; none sends it explicitly.",
      iqUpstreamDefault: "Upstream default (omit parameter)",
      iqCapabilitiesUpstream: "Capabilities: upstream.",
      iqCapabilitiesReference: "Capabilities: reference, unverified for this account.",
      iqCapabilitiesUnknown: "Capabilities unknown; custom values can be saved.",
      iqEffortUnsupported: "This effort is unavailable for the selected model. Choose another.",
      iqModelsFailed: "Sync failed. Try again. Your selected model is unchanged.",
      ...
      iqCompat: "Compatible",
      iqStrict: "Strict format",
      iqStrictHint: "Unsupported format or parameters produce Unknown, without retries or model fallback. An unambiguous answer is graded even if its format differs.",
      iqBulkFieldsHint: "Only checked fields change; other settings retain each account’s value. Enter a model ID for bulk edits.",
      iqSelectFields: "Select the check fields to change and correct invalid values.",
      iqNormalizedAnswer: "Answer",
      iqRawAnswer: "View original answer",
      iqRunning: "Running",
      iqLegacyResult: "Some details are unavailable for this older record",
      iqFormatMismatch: "Format differed; the explicit answer was graded.",
      iqReportedModel: "Returned model",
      iqGrader: "Grader version",
      iqTimeout: "Check timeout (seconds)",
      iqExecution: "Execution",
      iqNextEligible: "Next eligible time",
      iqLastAssessment: "Last assessment",
      iqDownload: "Download diagnostics",
      iqQueuedAt: "Queued; earliest execution: {time}",
      iqExecutionStates: {
        retry_wait: 'Waiting for recovery attempt',
        protocol_cooldown: 'Repeated protocol failures; checks resume after cooldown',
"idle": "Waiting", "pending": "Pending", "running": "Running", "deferred": "Deferred", "paused": "Paused"},
      iqFreshness: {"fresh": "Recent result", "stale": "Stale result", "never_checked": "Never checked"},
      iqExecutionReasons: {
        retry_wait: 'Waiting for recovery attempt',
        protocol_cooldown: 'Repeated protocol failures; checks resume after cooldown',
"group_paused": "Quota group paused; resolve quota and requeue","minimum_interval": "Minimum interval", "upstream_cooldown": "Upstream cooldown", "daily_budget": "Daily budget exhausted", "group_daily_budget": "Group daily budget exhausted", "group_cooldown": "Group cooldown", "quota_group_unconfigured": "Quota group not configured", "account_disabled": "Account disabled", "account_expired": "Account expired", "account_cooldown": "Account cooldown", "account_quota": "Account quota exhausted", "account_unavailable": "Account unavailable", "concurrency_unavailable": "Concurrency unavailable", "waiting_state": "Waiting for STATE", "state_recovered": "STATE recovered; check queued", "account_busy": "Account busy", "start_unavailable": "Start unavailable", "quota_exhausted": "Quota exhausted; resolve before requeuing", "authentication_unavailable": "Authentication failed; check credentials", "permission_denied": "Permission denied; check authorization", "policy_denied": "Upstream denied; contact provider", "unsupported_model": "Unsupported model; update configuration", "unsupported_parameter": "Unsupported parameter; update configuration"},
      iqReasons: {
        no_valid_history: 'No valid history for this configuration',
        zero_byte_response: 'No response body received',
        missing_final_message: 'Response completed without a final message',
        empty_final_text: 'Final message contains no answer text',
        retry_deadline_exceeded: 'Recovery deadline exceeded',
        invalid_output_identity: 'Invalid output identity',
        invalid_completed_message: 'Invalid completed message identity or status',
        conflicting_output_identity: 'Conflicting output identities',

        unsupported_parameter: "Unsupported parameter; update configuration",
        policy_denied: "Upstream denied; contact provider",
        permission_denied: "Permission denied; check authorization",
        quota_exhausted: "Quota exhausted; resolve before requeuing",
        start_unavailable: "Start unavailable",
        account_busy: "Account busy",
        concurrency_unavailable: "Concurrency unavailable",
        account_quota: "Account quota exhausted",
        account_cooldown: "Account cooldown",
        account_expired: "Account expired",
        account_disabled: "Account disabled",
        quota_group_unconfigured: "Quota group not configured",
        group_cooldown: "Group cooldown",
        group_daily_budget: "Group daily budget exhausted",
        daily_budget: "Daily budget exhausted",
        upstream_cooldown: "Upstream cooldown",
        minimum_interval: "Minimum interval",
        response_format_mismatch: 'Response headers and body format do not match',
        unsupported_media_type: 'Upstream returned an unsupported media type',
        invalid_event_json: 'Response event contains invalid JSON',
        duplicate_critical_field: 'Duplicate critical response fields prevent reliable grading',
        duplicate_event_field: 'Response event contains duplicate fields',
        invalid_event_shape: 'Response event field has an unexpected type',
        invalid_terminal_response: 'Complete final response object is missing',
        event_type_mismatch: 'Response event name and content disagree',
        data_after_done: 'Additional data received after stream end',
        event_too_large: 'Response event exceeds the size limit',
        too_many_events: 'Response event count exceeds the limit',
        response_decompression_failed: 'Upstream response decompression failed',
        unsupported_content_encoding: 'Unsupported response compression',
        conflicting_final_response: 'Final responses conflict',
        empty_response: "Empty response",
        invalid_answer_structure: "Invalid answer structure or duplicate fields",
        unparseable_answer: "No unambiguous final answer found",
        response_read_failed: "Response reading interrupted",
        upstream_error: "Upstream response contains an error",
        request_failed: "Upstream request failed",
        transport_unavailable: "Request transport unavailable",
        account_unavailable: "Account unavailable",
        authentication_unavailable: "Account authentication unavailable",
        unsupported_account_type: "Unsupported account type",
        invalid_endpoint: "Invalid upstream endpoint",
        http_400: "Upstream rejected model, parameters or request",
        http_403: "Upstream temporarily rejected the request (HTTP 403)",
        http_404: "Upstream model or endpoint not found",
        http_500: "Upstream internal error",
        http_502: "Upstream gateway error",
        http_503: "Upstream unavailable",
        correct_answer: "Answer is 21",
        wrong_answer: "Explicit answer differs from 21",
        ambiguous_answer: "Ambiguous or conflicting answer",
        answer_not_found: "No explicit answer found",
        invalid_answer: "Answer cannot be parsed",
        invalid_json: "Invalid JSON or duplicate fields",
        conflicting_answers: "Conflicting answers",
        refusal: "Upstream refusal",
        timeout: "Request timed out",
        interrupted: "Check interrupted; scheduling restored",
        configuration_changed: "Configuration changed; awaiting a new check",
        cancelled_by_account_change: "Account or configuration changed; old result discarded",
        http_401: "Authentication failed",
        http_429: "Upstream quota or rate limit",
        unsupported_model: "Unsupported model or account",
        empty_answer: "Empty answer",
        incomplete_response: "Incomplete response",
        invalid_response: "Invalid response protocol",
        response_too_large: "Response exceeds size limit",
        stream_interrupted: "Response stream interrupted",
        transport_error: "Upstream connection failed",
      },
      iqDiagnostic: "Check details",
      iqDiagnosticHint: 'No gradable answer was obtained. Existing scheduling rules apply while the result is unknown.',
      iqDiagnosticLabels: {
        ignored_types: 'Ignored item types',
        done_messages: 'Completed messages',
        terminal_items: 'Terminal output items',
 ...
 error_code: "Upstream error code", error_type: "Error type", retry_after: "Upstream retry time", retry_after_unbounded: "Retry delay unbounded; paused", input_tokens: "Input tokens", output_tokens: "Output tokens", reasoning_tokens: "Reasoning tokens", retry_visibility: "Request attempts",  parser_version: 'Parser version', stage: 'Stage', code: 'Reason code', http_status: 'HTTP status', media_type: 'Media type', content_encoding: 'Compression', protocol: 'Protocol', transport: 'Transport', format_detected: 'Format detected', event_type: 'Event type', event_index: 'Event index', field: 'Field path', offset: 'Byte offset', bytes_read: 'Bytes read', request_id: 'Upstream request ID' },
      ...
      usageWindowsHint: '"5h / 7d" are the upstream account\'s official rolling usage windows (e.g. OpenAI ChatGPT, Claude). They are imposed by the upstream provider on the account itself — not configured by xy2api, and unrelated to the models you map. Usage resets automatically once each window rolls over, and the limit cannot be lifted from within xy2api.',
      ollamaCloud: {
      ...
      upstreamBilling: {
        trustWarning: 'This rate is declared by the upstream site for the current API key. XY2API cannot verify that it matches actual charges. The upstream site or an intermediary may return forged, stale, or modified data. Verify it against bills, balance changes, and actual usage.',
      ...
      grok: {
        ...
        ttsTextPlaceholder: 'Example: Hello from XY2API connectivity test.',
        ttsTextDefault: 'Hello from XY2API account connectivity test.',
      ...
      poolModeInfo:
        'When enabled, upstream 429/403/401 errors will auto-retry without marking the account as rate-limited or errored. Suitable for upstream pointing to another xy2api instance.',
