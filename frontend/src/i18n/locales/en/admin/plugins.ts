export default {
  plugins: {
    ...
    runtimeNotice: 'Plugin installation, enable/disable, and configuration are handled dynamically by the XY2API host and normally do not require a host restart. Restart only when the host version or host configuration changes according to your deployment process.',
    ...
    emptyHint: 'Select a local .s2plugin package. XY2API never downloads third-party plugins automatically.',
    configure: 'Configure',
    enable: 'Enable',
    disable: 'Disable',
    test: 'Test',
    ...
    currentXY2APIVersion: 'Current XY2API',
    currentSub2APICompatVersion: 'Sub2API compatibility baseline',
    ...
    confirmDisable: 'Disable this plugin? New OAuth requests immediately return to the built-in XY2API path.',
    confirmUninstall: 'Uninstall this plugin? It must be disabled first. Installed files and configuration will be removed.',
    confirmUntested: 'This plugin is compatible but has not declared the current Sub2API compatibility baseline as tested. Enable it anyway?',
