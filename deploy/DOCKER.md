...
XY2API is an AI API Gateway Platform for distributing and managing AI product subscription API quotas.
...
docker run -d \
  --name xy2api \
  -p 8080:8080 \
  -e DATABASE_URL="postgres://user:pass@host:5432/xy2api" \
  -e REDIS_URL="redis://host:6379" \
  ghcr.io/liulixin-lex/xy2api:latest
```
...
services:
  xy2api:
    image: ghcr.io/liulixin-lex/xy2api:latest
    ports:
      - "8080:8080"
    environment:
      - DATABASE_URL=postgres://postgres:postgres@db:5432/xy2api?sslmode=disable
...
- [GitHub Repository](https://github.com/liulixin-lex/xy2api)
- [Documentation](https://github.com/liulixin-lex/xy2api#readme)
